...
<style>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Edit Prangonemor about form</h4>
                    ...
                    <form class="form-horizontal" action="{{route('abouts.update',$about->id)}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-3 text-center ">
                                <div class="image_preview  " ><img class="image_preview"  src="{{asset($about->image)}}"></div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <textarea id="editor" name="details" class="form-control ck" placeholder="Enter about Prangonemor">{!!$about->details!!}</textarea>
