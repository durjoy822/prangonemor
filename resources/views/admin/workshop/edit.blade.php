...
@section('title') Workshop Edit @endsection
@section('body')
<style>
    .image_preview{
        width: 70px;
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Edit Workshop form</h4>
                    ...
                    <form class="form-horizontal" action="{{route('workshops.update',$workshop->id)}}" method="POST" enctype="multipart/form-data">
                       ...
                       <div class="row ">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="title" value="{{$workshop->title}}" id="inputEmail31" placeholder="Enter name"/>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-9 mt-2">
                                <input type="file" class="form-control" name="title_image" value="{{$workshop->title_image}}" id="title_image"/>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-9 mt-2">
                                <input type="file" class="form-control" name="feature_image" value="{{$workshop->feature_image}}"  id="feature_image"/> 
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-9 mt-2">
                                <input type="file" class="form-control" name="video_image" id="video_image" value="{{$workshop->video_image}}" /> 
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-9 mt-2">
                                <input type="text" class="form-control" name="video_link" id="inputEmail3" value="{{$workshop->video_link}}"  placeholder="Video link"/>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-9">
                                <textarea  class="form-control " id="summernote" name="description_one"  placeholder="Description One"> {{$workshop->description_one}}</textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-9"> 
                                <textarea  class="form-control " id="summernote2" name="description_two"  placeholder="Description Two"> {{$workshop->description_two}} </textarea>
