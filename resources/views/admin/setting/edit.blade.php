                            ...
                            <div class="row">
                                <div class="col-md-4 text-center">
                                    ...
                                    <div class="d-flex justify-content-center align-items-center mb-2">
                                        <div class="image_preview_a "><img src="{{asset($setting->dark_logo)}}" alt="dark_logo"></div>
                                    </div>
                                    ...
                                    <div class="mt-3 d-flex justify-content-center align-items-center mb-2">
                                        <div class="image_preview_b"><img src="{{asset($setting->white_logo)}}" alt="white_logo"></div>
                                    </div>
                                ...
                                <div class="col-md-8 ">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="app_name" value="{{$setting->app_name}}" class="form-control" placeholder="App name">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <select class="form-control" name="country">
                                            ...
                                            <option value="Bangladesh" {{$setting->country=='Bangladesh'?'selected':''}} >Bangladesh</option>
                                        </select>
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input type="text" name="state" value="{{$setting->state}}" class="form-control" placeholder="State">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input type="text" class="form-control" value="{{$setting->facebook}}" name="facebook" placeholder="Facebook link">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input type="text" class="form-control" value="{{$setting->twitter}}" name="twitter" placeholder="Twitter link">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input type="text" class="form-control" value="{{$setting->instagram}}" name="instagram" placeholder="instagram link">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input type="text" class="form-control" value="{{$setting->pinterest}}" name="pinterest" placeholder="Pinterest link">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <input type="text" class="form-control" value="{{$setting->copyright}}" name="copyright" placeholder="Copyright">
