...
@section('title') Contact Create @endsection
@section('body')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{route('contacts.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="number" class="form-control" value="{{old('phone')}}" name="phone" id="inputEmail32" placeholder="Phone number"/>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="number" class="form-control"  value="{{old('telephone')}}"  name="telephone" id="inputEmail33" placeholder="Telephone Number"/>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="email" class="form-control"  value="{{old('email')}}"  name="email" id="inputEmail33" placeholder="Enter email address"/>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="map"  value="{{old('map')}}"  placeholder="Enter google map link"/>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control"  value="{{old('address')}}"  name="address" cols="3" rows="3" placeholder="Enter address"></textarea>
