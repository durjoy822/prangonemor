                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{route('teams.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="designation" id="inputEmail31" placeholder="Enter name"/>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="email" class="form-control" name="email" id="inputEmail31" placeholder="Enter name"/>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="phone" id="inputEmail31" placeholder="Enter name"/>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" name="personal_info"></textarea>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="experience" id="inputEmail31" placeholder="Enter name"/>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="location" id="inputEmail31" placeholder="Enter name"/>
                         ...
                         <div class="row mb-3 justify-content-end">
                            ...
                            <div class="col-md-9">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio"  name="member_type" id="inlineRadio3" value="3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="website" id="inputEmail33" placeholder="website link"/>
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="linkdin" id="inputEmail33" placeholder="Instagram link"/>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="inputEmail33" class="col-md-3 col-form-label">Youtube Link</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="youtube" id="inputEmail33" placeholder="Instagram link"/>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="inputEmail33" class="col-md-3 col-form-label">Long Description</label>
                            <div class="col-md-9"> 
                                <textarea class="form-control snow-editor" style="height: 300px" name="long_description"  placeholder="Description One"></textarea>
