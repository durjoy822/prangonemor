        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{route('galleries.update',$gallery->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                       @method('put')
                        <div class="row ">
                            <label for="inputEmail31" class="col-md-3 col-form-label">Name</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" value="{{ $gallery->name }}" name="name" id="inputEmail31" placeholder="Enter name"/>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class=" col-md-6 mt-1">
                                ...
                                <img src="{{ asset($gallery->image) }}" alt="img" style="width: 50px; height: 50px">
