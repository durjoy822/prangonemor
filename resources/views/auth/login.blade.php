...
<head>
    <meta charset="utf-8"/>
    <title>Prangonemor | Admin Login</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="A fully featured admin theme which can be used to build CRM, CMS, etc." name="description" />
    <meta content="Coderthemes" name="author"/>
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{asset('/')}}admin/assets/images/prelodar.jpeg"/>
    <!-- Theme Config Js -->
...
<div class="accou   nt-pages pt-2 pt-sm-5 pb-4 pb-sm-5">
    <div class="container">
            ...
            <div class="col-xxl-4 col-lg-5">
                <div class="card">
                    ...
                    <div class="card-header text-center bg-dark">
                        <a href="">
                            <span><img src="{{asset('/')}}admin/assets/images/pppp.jpeg" alt="logo" class="w-75" height="80"/></span>
                        </a>
                    </div>
